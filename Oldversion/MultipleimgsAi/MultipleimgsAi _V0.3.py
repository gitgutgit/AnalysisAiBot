...
def analyze_image(image_path):
    ...
    prompt = f"""You are an expert in analyzing commercial videos, capable of thoroughly explaining camera techniques, the number of people present in the current shot, and other such elements. Here is the list of elements (explain in korean): {json.dumps(json_template_kor)}"""
